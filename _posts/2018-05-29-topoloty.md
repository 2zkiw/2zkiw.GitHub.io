...
# Continuity in $R^m$
A function f: $R^n$ $\rightarrow$ $R^m$ is continuous at c $\in$ $R^n$ if $\displaystyple{\lim_{x \to{c}} f(x)}$ = f(c). 
...
If f: $R^n$ $\rightarrow$ $R^m$ is continuous at c and g: $R^m$ $\rightarrow$ $R^k$ is continuous at f(c), then g$\circle$f: $R^n$ $\rightarrow$ $R^k$ is continuous at c. 
